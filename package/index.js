...
const createComposiApp = (() => {
  ...
  function getHelp() {
    ...
    console.log(chalk`{white.bold This should follow the flag '--name' or '-n'.}`)
    console.log(' ')
    console.log(chalk`{bold Example: create-composi-app --name "Project Name"}`)
    ...
    console.log(chalk`{green.bold This should flow the flag '--path' or '-p'.}`)
    console.log(' ')
    console.log(chalk`{green.bold Mac & Linux:} create-composi-app --name "Project Name" --path "~/Desktop/dev/personal"`)
    console.log(chalk`{green.bold Mac & Linux:} create-composi-app -n "Project Name" -p "~/Desktop/dev/personal"`)
    console.log(' ')
    console.log(chalk`{green.bold Windows:} create-composi-app --name "Project Name" --path"~\\Desktop\\dev\\personal"`)
    console.log(' ')
